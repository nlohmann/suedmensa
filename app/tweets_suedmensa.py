...
CREDENTIALS = json.load(open(os.path.join(__location__, 'credentials_suedmensa.json'), 'r'))
...
tweet1 = "VITAL: %s" % tweets(m['theken']['vital'])
tweet2 = "THEKE 1: %s ‖ PASTA: %s ‖ AKTION: %s" % (tweets(m['theken']['theke1']), tweets(m['theken']['pasta']), tweets(m['theken']['aktion']))
