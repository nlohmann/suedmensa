...
CREDENTIALS = json.load(open(os.path.join(__location__, 'credentials_mensastgeorg.json'), 'r'))
...
tweet2 = "THEKE 1: %s" % tweets(m['theken']['theke1'])
tweet3 = "THEKE 3: %s ‖ %s!" % (tweets(m['theken']['theke3']), bon_appetit())
